...
class Diagnosis_features(BaseFeature):
    ...
    def calculate_batch(self, ids):
        ...
        inpat_diags=InpatientDataset(self.diag_features_prefix).get_patient_lines_in_train_time(ids)
        ...
        outpat_diags=OutpatientDataset(self.diag_features_prefix).get_patient_lines_in_train_time(ids)
